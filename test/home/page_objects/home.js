exports.blazedemo_home = class BlazeDemo_Home {
    ...
    async select_departure_paris(){
        await this.departure_paris.selectOption("Paris", {timeout: 40000})
    }
    async select_departure_philadelphia(){
        await this.departure_philadelphia.selectOption("Philadelphia", {timeout: 40000})
    }
    async select_departure_boston(){
        await this.departure_boston.selectOption("Boston", {timeout: 40000})
    }
    async select_departure_portland(){
        await this.departure_portland.selectOption("Portland", {timeout: 40000})
    }
    async select_departure_san_diego(){
        await this.departure_san_diego.selectOption("San Diego", {timeout: 40000})
    }
    async select_departure_mexico_city(){
        await this.departure_mexico_city.selectOption("Mexico City", {timeout: 40000})
    }
    async select_departure_sao_paolo(){
        await this.departure_sao_paolo.selectOption("Sao Paolo", {timeout: 40000})
    }
    async select_destination_buenos_aires(){
        await this.destination_buenos_aires.selectOption("Buenos Aires", {timeout: 40000});
    }
    async select_destination_rome(){
        await this.destination_rome.selectOption("Rome", {timeout: 40000})
    }
    async select_destination_london(){
        await this.destination_london.selectOption("London", {timeout: 40000})
    }
    async select_destination_berlin(){
        await this.destination_berlin.selectOption("Berlin", {timeout: 40000})
    }
    async select_destination_new_york(){
        await this.destination_new_york.selectOption("New York", {timeout: 40000})
    }
    async select_destination_dublin(){
        await this.destination_dublin.selectOption("Dublin", {timeout: 40000})
    }
    async select_destination_cairo(){
        await this.destination_cairo.selectOption("Cairo", {timeout: 40000})
    }
    async close(){
        await this.page.close()
    }
    async submitButton_findFlights(){
        await this.findFlights.click({timeout: 40000});
    }
}
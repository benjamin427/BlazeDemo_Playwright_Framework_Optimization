exports.blazedemo_reserve_flight_purchase = class BlazeDemo_FlightPurchase {
    ...
    async select_card_visa(){
        await this.card_type_visa.selectOption('Visa', {timeout: 25000})
    }
    async select_card_diners_club(){
        await this.card_type_diners_club.selectOption("Diner's Club", {timeout: 25000})
    }
    async select_card_american_express(){
        await this.card_type_american_express.selectOption("American Express", {timeout: 25000})
    }
    async checkbox(){
        await this.checkboxRemember.setChecked(true)
    }
    async submitButton(){
        await this.submitButtonPurchaseFlight.click({timeout: 25000})
    }
    async close(){
